...
class Lvl4 extends Component
{
    ...
    #[Validate('required|date|before:today', message:["birth_date.required" => "تاریخ تولد الزامی است", "birth_date.before" => "تاریخ تولد باید در ماضی باشد", "birth_date.date" => "فرمت تاریخ نامعتبر است"])]
    public $birth_date;
