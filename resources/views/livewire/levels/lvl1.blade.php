...
{{--        </div>--}}
        <div class="w-full" >
            ...
            <div class="flex flex-col gap-1 pr-3" >
                <p>فقط ویژه پسران متولد 88 تا 93</p>
                <p>هزینه ثبت نام هرنفر سی صد و پنجاه هزار تومان.</p>
                ...
                <p>پیور تجربه سالیان گذشته در مورد پیچیدگی اجرایی ملاقات والدین با فرزندان معتکف خود  و نیز مغایرت فلسفه اعتکاف با این گونه ملافات ، لذا ثبت نام کنندگان بدانند که امسال به هیچ وجه امکان ملاقات به جز در مراسم اعمال ام داوود (بعد از ظهر روز سوم) وجود ندارد.</p>
