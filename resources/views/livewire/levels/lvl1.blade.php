...
{{--        </div>--}}
        <div class="w-full" >
            ...
            <div class="flex flex-col gap-1 pr-3" >
                ...
                <div class="flex gap-1">
                    <span>-</span>
                    <p>هزینه ثبت‌نام هرنفر سیصدوپنجاه هزارتومان است</p>
                </div>
                <div class="flex gap-1">
                    <span>-</span>
                ...
                <div class="flex gap-1">
                    <span>-</span>
                    <p>پیرو تجربه سالیان گذشته در مورد پیچیدگی اجرایی ملاقات والدین با فرزندان معتکف و نیز مغایرت فلسفه اعتکاف با اینگونه ملاقات، ثبت‌نام‌کنندگان بدانند که امسال به هیچ وجه امکان ملاقات، به‌جز در مراسم اعمال امّ‌داوود (بعدازظهر روزسوم)، وجود ندارد</p>
                </div>
                <div class="flex gap-1">
                    <span>-</span>
