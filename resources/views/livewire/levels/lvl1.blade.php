        ...
        <div class="w-full" >
            ...
            <div class="flex flex-col gap-1 pr-3" >
                <div class="flex gap-1">
                    <span>-</span>
                    <p>این اعتکاف ویژه پسران متولد هزار و سیصد و هشتاد و نه تا هزار و سیصد و نود و سه می‌باشد</p>
                </div>
                <div class="flex gap-1">
                    <span>-</span>
                    <p>هزینه ثبت‌نام هر نفر سیصدوپنجاه هزار تومان است</p>
                </div>
                <div class="flex gap-1">
                    <span>-</span>
                ...
                <div class="flex gap-1">
                    <span>-</span>
                    <p>به دلیل مصرف شدن مبلغ پرداختی شما برای ثبت‌نام در امور برپایی خیمه، هرگونه انصراف و استرداد مبلغ مقدور نمی‌باشد</p>
                </div>
                <div class="flex gap-1">
                    <span>-</span>
                    <p>پیرو تجربه سالیان گذشته در مورد پیچیدگی اجرایی ملاقات والدین با فرزندان معتکف و نیز مغایرت فلسفه اعتکاف با این گونه ملاقات، ثبت‌نام‌کنندگان بدانند که امسال به هیچ وجه امکان ملاقات، به‌جز در مراسم اعمال امّ‌داوود (بعدازظهر روزسوم)، وجود ندارد</p>
                </div>
                <div class="flex gap-1">
                    <span>-</span>
