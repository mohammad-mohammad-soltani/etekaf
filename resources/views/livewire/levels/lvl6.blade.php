<div class="flex flex-col justify-center items-center gap-2 mt-2" >
    ...
    <div class="w-full h-full flex justify-center" >
        <div class="map grid grid-rows-[9fr_12.5fr_12.5fr_12.5fr_2.5fr_2fr] grid-cols-[1.45fr_1fr_1.45fr] gap-1 p-1 aspect-[49/52] w-[90%] md:w-[80%] lg:w-[90%] xl:w-[70%] 2xl:w-[60%] text-white" data-theme="light" >
            ...
            <label for="esmail" class="{{\App\Services\Capacity::have_capacity('haniyeh') > 0 ? 'dark:bg-green-400/40 bg-green-800' : 'dark:bg-zinc-600 bg-zinc-200 not-dark:text-zinc-800 pointer-events-none'}} w-full duration-200 peer-checked/esmail:bg-yellow-300 peer-checked/esmail:text-black dark:text-white text-white col-start-1 row-start-1 row-end-2">
            ...
            <label for="hashem" class="{{\App\Services\Capacity::have_capacity('safieddine') > 0 ? 'dark:bg-green-400/40 bg-green-800' : 'dark:bg-zinc-600 bg-zinc-200 not-dark:text-zinc-800 pointer-events-none'}} w-full duration-200 peer-checked/hashem:bg-yellow-300 peer-checked/hashem:text-black col-start-2 row-start-1 row-end-2">
            ...
            <label for="emad" class="{{\App\Services\Capacity::have_capacity('mughniyeh') > 0 ? 'dark:bg-green-400/40 bg-green-800' : 'dark:bg-zinc-600 bg-zinc-200 not-dark:text-zinc-800 pointer-events-none'}} peer-checked/emad:bg-yellow-300 duration-200 peer-checked/emad:text-black dark:text-white col-start-3 row-start-1 row-end-2">
            ...
            <label for="alzeif" class="{{\App\Services\Capacity::have_capacity('deif') > 0 ? 'dark:bg-green-400/40 bg-green-800' : 'dark:bg-zinc-600 bg-zinc-200 not-dark:text-zinc-800 pointer-events-none'}} peer-checked/alzeif:bg-yellow-300 duration-200 peer-checked/alzeif:text-black dark:text-white col-start-1 row-start-2 row-end-3">
            ...
            <label for="sinwar" class="{{\App\Services\Capacity::have_capacity('sinwar') > 0 ? 'dark:bg-green-400/40 bg-green-800' : 'dark:bg-zinc-600 bg-zinc-200 not-dark:text-zinc-800 pointer-events-none'}} peer-checked/sinwar:bg-yellow-300 duration-200 peer-checked/sinwar:text-black dark:text-white col-start-1 row-start-3 row-end-4">
            ...
            <label for="yamen" class="{{\App\Services\Capacity::have_capacity('yamen') > 0 ? 'dark:bg-green-400/40 bg-green-800' : 'dark:bg-zinc-600 bg-zinc-200 not-dark:text-zinc-800 pointer-events-none'}} peer-checked/yamen:bg-yellow-300 duration-200 peer-checked/yamen:text-black dark:text-white col-start-1 row-start-4 row-end-5">
            ...
            <label for="ghantar" class="{{\App\Services\Capacity::have_capacity('kuntar') > 0 ? 'dark:bg-green-400/40 bg-green-800' : 'dark:bg-zinc-600 bg-zinc-200 not-dark:text-zinc-800 pointer-events-none'}} peer-checked/ghantar:bg-yellow-300 duration-200 peer-checked/ghantar:text-black dark:text-white col-start-1 row-start-5 row-end-7">
            ...
            <label for="almohandes" class="{{\App\Services\Capacity::have_capacity('muhandis') > 0 ? 'dark:bg-green-400/40 bg-green-800' : 'dark:bg-zinc-600 bg-zinc-200 not-dark:text-zinc-800 pointer-events-none'}} peer-checked/almohandes:bg-yellow-300 duration-200 peer-checked/almohandes:text-black dark:text-white col-start-2 row-start-4 row-end-6">
            ...
            <label for="solaimani" class="{{\App\Services\Capacity::have_capacity('soleimani') > 0 ? 'dark:bg-green-400/40 bg-green-800' : 'dark:bg-zinc-600 bg-zinc-200 not-dark:text-zinc-800 pointer-events-none'}} peer-checked/solaimani:bg-yellow-300 duration-200 peer-checked/solaimani:text-black dark:text-white col-start-2 row-start-2 row-end-3 ">
            ...
            <label for="nasr_allah" class="{{\App\Services\Capacity::have_capacity('nasrallah') > 0 ? 'dark:bg-green-400/40 bg-green-800' : 'dark:bg-zinc-600 bg-zinc-200 not-dark:text-zinc-800 pointer-events-none'}} peer-checked/nasr_allah:bg-yellow-300 duration-200 peer-checked/nasr_allah:text-black dark:text-white col-start-2 row-start-3 row-end-4 ml-1 mr-1">
