<div x-data="{ current_tab: {{$current_level}} , max_tab : 5}" class="w-full h-[100vh] l lg:h-[75vh] xl:h-[65vh] 2xl:h-[74vh]  lg:w-[85%] xl:w-[80%] 2xl:w-[70%]  border-seccondary/19 dark:border-white/20 border-1 rounded-none lg:rounded-[3rem] flex" >
